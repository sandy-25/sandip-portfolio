...
export const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: 'ADO.NET', icon: 'SiDotnet', category: 'backend', proficiency: 70, yearsOfExperience: 4 },
      { name: 'SignalR', icon: 'TbBrandSignalR', category: 'backend', proficiency: 70, yearsOfExperience: 3, highlight: true },
  ...
  },
  {
    ...
    color: 'violet',
    skills: [
      { name: 'React.js', icon: 'SiReact', category: 'frontend', proficiency: 80, yearsOfExperience: 4, highlight: true },
      { name: 'TypeScript', icon: 'SiTypescript', category: 'frontend', proficiency: 80, yearsOfExperience: 3, highlight: true },
      { name: 'JavaScript', icon: 'SiJavascript', category: 'frontend', proficiency: 95, yearsOfExperience: 5 },
      { name: 'Tailwind CSS', icon: 'SiTailwindcss', category: 'frontend', proficiency: 60, yearsOfExperience: 3 },
      { name: 'Angular 9', icon: 'SiAngular', category: 'frontend', proficiency: 60, yearsOfExperience: 2 },
      { name: 'HTML5', icon: 'SiHtml5', category: 'frontend', proficiency: 90, yearsOfExperience: 5 },
      { name: 'CSS3', icon: 'SiCss3', category: 'frontend', proficiency: 70, yearsOfExperience: 5 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'CI/CD', icon: 'TbGitPullRequest', category: 'tools', proficiency: 70, yearsOfExperience: 3 },
